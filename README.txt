...
Even though the plug-in is easily installable you have to touch your template folder as well. Put this code into 404.php page in your template folder if 
...
2. Once you activate the plug-in go to your current template folder (wp-content/themes/your-template/) and put the following piece of PHP code into the 404.php file.
'<?php if (function_exists('funct_404_error_carrot')) funct_404_error_carrot(); ?>'
